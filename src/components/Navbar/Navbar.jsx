        ...
        >
          <li className="leading-10">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "block sm:inline w-full sm:w-auto bg-pinkshadow rounded-xl text-pink pl-2 p-0 sm:p-4 "
                  : "block sm:inline w-full sm:w-auto bg-transparent text-black pl-2 sm:pl-0 sm:hover:p-4 hover:rounded-xl hover:bg-pinkshadow hover:text-pinkungu"
              }
            >
              Dasboard
            </NavLink>
